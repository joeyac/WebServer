...
class Submission(models.Model):
    submission_id = models.AutoField(primary_key=True, verbose_name='Run ID')
    ...
    create_time = models.DateTimeField(auto_now_add=True, verbose_name='Submit Time')
    ...
    def __str__(self):
        return "[{user_name}]:{id}".format(user_name=self.user.username, id=self.problem.__str__())
